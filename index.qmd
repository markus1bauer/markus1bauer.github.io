...
```{r Salvio-Arrhenateretum, echo=FALSE, align="center", fig.cap="[Salvio-Arrhenatheretum](https://floraveg.eu/vegetation/overview/arrhenatherion), Wipelsfurt &copy; Markus Bauer"}
knitr::include_graphics(here::here("images", "titel4.jpg"))
```
...
### [Publikationen](2_publikationen.qmd)
...
Germany 
<br>
[www.lss.ls.tum.de/roek](www.lss.ls.tum.de/roek)
<br>
...
```{r Festuco-Brometea, echo=FALSE, align="center", fig.cap="[Cirsio-Bracypodion pinnati](https://floraveg.eu/vegetation/overview/Cirsio-Brachypodion%20pinnati), Kalbenstein &copy; Markus Bauer"}
